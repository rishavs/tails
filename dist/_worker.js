...
var require_decode = __commonJS({
  "node_modules/entities/lib/decode.js"(exports) {
    ...
    function getDecoder(decodeTree) {
      var ret = "";
      var decoder3 = new EntityDecoder(decodeTree, function(str) {
...
var require_parse3 = __commonJS({
  "node_modules/cheerio/lib/parse.js"(exports) {
    ...
    function getParse(parser) {
      return function parse3(content, options, isDocument, context) {
...
var require_load = __commonJS({
  "node_modules/cheerio/lib/load.js"(exports) {
    ...
    var utils_js_1 = require_utils();
    function getLoad(parse3, render) {
      return function load(content, options, isDocument) {
        ...
        var initialRoot = parse3(content, internalOpts, isDocument, null);
        var LoadedCheerio = (
          /** @class */
          function(_super) {
            ...
            LoadedCheerio2.prototype._parse = function(content2, options2, isDocument2, context) {
              return parse3(content2, options2, isDocument2, context);
            };
        ...
        function initialize(selector, context, root, opts) {
          ...
          var elements = typeof selector === "string" && (0, utils_js_1.isHtml)(selector) ? (
            // $(<html>)
            parse3(selector, options2, false, null).children
          ) : isNode(selector) ? (
            // $(dom)
            [selector]
          ...
          var searchContext = !context ? (
            ...
            // $('li', '<ul>...</ul>')
            new LoadedCheerio([parse3(context, options2, false, null)], rootInstance, options2)
          ) : (
            // $('li', 'ul')
    ...
    var Tokenizer = class {
      ...
      _stateNumericCharacterReferenceEnd(cp) {
        if (this.charRefCode === unicode_js_1.CODE_POINTS.NULL) {
          ...
          const replacement2 = C1_CONTROLS_REFERENCE_REPLACEMENTS.get(this.charRefCode);
          if (replacement2 !== void 0) {
            this.charRefCode = replacement2;
          }
        }
  ...
  "node_modules/htmlparser2/lib/Tokenizer.js"(exports) {
    ...
    var Tokenizer = (
      ...
      function() {
        ...
        Tokenizer2.prototype.handleInAttributeValue = function(c, quote2) {
          if (c === quote2 || !this.decodeEntities && this.fastForwardTo(quote2)) {
            this.cbs.onattribdata(this.sectionStart, this.index);
            this.sectionStart = -1;
            this.cbs.onattribend(quote2 === CharCodes.DoubleQuote ? QuoteType.Double : QuoteType.Single, this.index);
            this.state = State.BeforeAttributeName;
          } else if (this.decodeEntities && c === CharCodes.Amp) {
            this.baseState = this.state;
            this.state = State.BeforeEntity;
  ...
  "node_modules/htmlparser2/lib/Parser.js"(exports) {
    ...
    var Parser = (
      ...
      function() {
        ...
        Parser2.prototype.onattribend = function(quote2, endIndex) {
          var _a, _b;
          this.endIndex = endIndex;
          (_b = (_a = this.cbs).onattribute) === null || _b === void 0 ? void 0 : _b.call(_a, this.attribname, this.attribvalue, quote2 === Tokenizer_js_1.QuoteType.Double ? '"' : quote2 === Tokenizer_js_1.QuoteType.Single ? "'" : quote2 === Tokenizer_js_1.QuoteType.NoValue ? void 0 : null);
...
var require_lib10 = __commonJS({
  "node_modules/cheerio/lib/index.js"(exports) {
    ...
    var parse3 = (0, parse_js_1.getParse)(function(content, options, isDocument, context) {
    ...
    exports.load = (0, load_js_1.getLoad)(parse3, function(dom, options) {
...
var require_punycode = __commonJS({
  "node_modules/punycode/punycode.js"(exports, module) {
    (function(root) {
      ...
      var punycode, maxInt = 2147483647, base = 36, tMin = 1, tMax = 26, skew = 38, damp = 700, initialBias = 72, initialN = 128, delimiter = "-", regexPunycode = /^xn--/, regexNonASCII = /[^\x20-\x7E]/, regexSeparators = /[\x2E\u3002\uFF0E\uFF61]/g, errors2 = {
...
var require_querystring = __commonJS({
  "node_modules/querystring/index.js"(exports) {
    "use strict";
    exports.decode = exports.parse = require_decode2();
        ...
        return __generator(this, function(_e) {
          switch (_e.label) {
            ...
            case 7:
              clearTimeout(timeoutCounter);
              headers = {};
              response.headers.forEach(function(header2, key) {
                headers[key] = header2;
              });
              _d = {
...
// src/handlers/getLinkData.js
var getLinkData = async (ctx) => {
...
var customAlphabet2 = (alphabet, size = 21) => customRandom(alphabet, size, random);
var nanoid = (size = 21) => {
  let id = "";
...
function decode3(text) {
  return text ? decoder2.decode(uint8Array(text)) : "";
}
...
async function postJSON(config, fetch2, url, body = {}) {
...
function cast(field, value) {
  ...
  switch (field.type) {
    ...
    case "JSON":
      return value ? JSON.parse(decode3(value)) : value;
    default:
...
var checkIfUserSlugExistsinDB = async (ctx, str) => {
...
var checkIfDomainBlocked = async (ctx, origin) => {
  let conn = connectToPlanetScale(ctx);
  let result = await conn.execute(
...
var getUserFromSession = async (ctx, sessionId) => {
  let conn = connectToPlanetScale(ctx);
  let query = `SELECT * FROM users WHERE id = (
        SELECT user_id FROM sessions WHERE id = :sessionId)
        limit 1`;
  let result = await conn.execute(query, { sessionId });
  return result.rows;
};
var saveNewPostInDB = async (ctx) => {
  let conn = connectToPlanetScale(ctx);
  let result = await conn.execute(
    `
        insert into posts 
...
var signinGoogleUser = async (ctx) => {
  ...
  if (resUserExists.length == 0) {
    ...
    user.id = customAlphabet2("0123456789abcdefghijklmnopqrstuvwxyz", 32)();
...
// src/handlers/buildNewPostPage.js
var buildNewPostPage = (ctx) => {
...
// src/handlers/validateNewPost.js
var validateNewPost = async (ctx) => {
  let formData = await ctx.req.raw.formData();
  ctx.post = {};
  ...
  if (ctx.post.type === "link") {
    if (ctx.post.link.length < NewPostSchema.linkMinLength || ctx.post.link.length > NewPostSchema.linkMaxLength) {
...
// src/handlers/saveNewPost.js
var saveNewPost = async (ctx) => {
...
// src/views/postDetails.js
var postDetails = async (post) => {
  return (
    /*html*/
    `
...
// src/handlers/isUserSlugDuplicate.js
var isUserSlugDuplicate = async (ctx) => {
  try {
